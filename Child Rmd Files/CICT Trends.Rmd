...
PHtracking %>%
  ...
  filter(ReportedWeekStart>="2021-11-08") %>%
...
plot_ly(x = ~`Day of Week`,
      ...
      #  boxpoints = "all",
        jitter = 0) %>%
layout(title = "Number of Cases Reported Each Day, by Day of Week and Time of Day Since Nov 8",
       boxmode = "group",
...
plot_ly(x = ~`Day of Week`,
       ...
       # boxpoints = "all",
        jitter = 0) %>%
layout(title = "Number of Cases Reported Each Day, by Day of Week Since Nov 8",
       boxmode = "group",
       font = list(family = "Arial", size = 12))
