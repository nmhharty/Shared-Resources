...
PHtracking %>%
  ...
  filter(ReportedWeekStart>="2021-12-13") %>%
...
plot_ly(x = ~`Day of Week`,
      ...
      #  boxpoints = "all",
        jitter = 0) %>%
layout(title = "Number of Cases Reported Each Day, by Day of Week and Time of Day Since Dec 13",
       boxmode = "group",
...
plot_ly(x = ~`Day of Week`,
       ...
       # boxpoints = "all",
        jitter = 0) %>%
layout(title = "Number of Cases Reported Each Day, by Day of Week Since Dec 13",
       boxmode = "group",
       font = list(family = "Arial", size = 12))
