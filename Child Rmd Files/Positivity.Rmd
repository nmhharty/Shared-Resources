...
plot_ly(data = (ConfProbCases %>%
  ...
  layout(margin = list(l=50,r=50,b=155,h=175),
         title = "Rolling 14-day Positivity and Tests Collected",
...
PCRpositivity %>%
  ...
  plot_ly(x = ~AttributionDate,
          ...
          groupnorm = 'percent',
          yaxis = "y",
          name = "14-day PCR Test Volume") %>%
  add_trace(x = ~AttributionDate,
            y = ~Sum14DayTestsANTIGEN,
            type = "scatter",
            name = "14-day Antigen Test Volume",
            fillcolor = I("#BB4628")) %>%
  # add_trace(x = ~AttributionDate,
  #           y = ~Sum14DayTests,
  #           type = "scatter",
  ...
  #           color = I("#F2BF4C")) %>%
  layout(margin = list(l=50,r=50,b=155,h=175),
         title = "Rolling 14-day Test Volume by Test Type Compared to County Total",
         xaxis = list(type = 'date',
                      tickformat = "%b %d, %Y",
                      autotick = F, 
                      tickangle = 45,
